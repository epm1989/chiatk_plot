...
from swarchiaplotmanagercustom.plotmanager.library.utilities.processes import get_manager_processes, update_plot
...
def print_view(jobs, running_work, analysis, drives, next_log_check, view_settings, loop):
    # Job Table
    #r = running_work[list(running_work.keys())[0]]
    #print(r.job, r.log_file, r.pid, r.plot_id)
